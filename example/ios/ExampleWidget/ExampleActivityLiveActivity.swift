...
struct ExampleActivityLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: ExampleActivityAttributes.self) { context in
...
// Preview
#if DEBUG
struct ExampleActivityLiveActivity_Previews: PreviewProvider {
    static let attributes = ExampleActivityAttributes(
        title: "Sample Activity",
        body: "This is a preview of your Live Activity"
    )
    
    static let contentState = ExampleActivityAttributes.ContentState(
        state: "active",
        relevanceScore: 0.75
    )
