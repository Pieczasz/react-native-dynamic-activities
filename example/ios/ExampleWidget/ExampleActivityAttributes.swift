...
extension ExampleActivityAttributes: LiveActivityBridge {
    static func startActivity(
        ...
        let attrs = ExampleActivityAttributes(
        ...
        do {
            let activity: Activity<ExampleActivityAttributes> = try Activity.request(
                attributes: attrs,
